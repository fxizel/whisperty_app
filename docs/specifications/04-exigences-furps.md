...
| **CO-16** | **Conformité / éthique** : l'enregistrement de réunion suppose le **consentement** des participants (responsabilité de l'utilisateur, rappelé par l'app). | M | UC-10 | Le démarrage du mode réunion affiche un rappel de consentement. |
